...
// //Fetch Item Details
//function fetchItemDetailsModification(sku) {                                                        /// commented out fetchItemDetails
...
//            populateFormFields(item);   // no need to populate data from old item
//            setupFormHandlers(sku);       // just call data input and upload

//        })
//        .catch(error => {
//            console.error('Error fetching item details:', error);
//            //const form = document.getElementById('itemModificationForm');                              ///////////////
//        });
//}
...
//            if (!uploadResponse.ok) {
//                alert('There was an error while uploading your items pictures and videos. Please try again!');
//                return uploadResponse.text().then(text => { throw new Error(`Error uploading files to sandbox: ${text}`); });
//            }
//            return uploadResponse.json();
//        })
//        .then(uploadResponse => {
//            //// Variables for second fetch call
//            //const itemCreatePath = `${baseUrl}/api/ItemModification/UpdateItem`;
//            //const { name, price, description, stockAvailable, productionCost, sellerContact } = item;
//            //const data = {
//            //    name,
//            //    sku: item.sku,
//            //    price,
...
//            //    stockAvailable,
//            //    productionCost,
//            //    offerablePrice: Boolean(item.offerablePrice),
//            //    sellerContact,
//            //    images: uploadData.images, // Assuming these fields are part of the response
//            //    videos: uploadData.videos,
//            //    listed: Boolean(item.itemListed)
//            //};

//            //return fetch(itemCreatePath, {
//            //    method: 'POST',
//            //    headers: {
//            //        'Authentication': idToken,
//            //        'Authorization': accessToken,
...
//                const offerablePrice = Boolean(document.getElementById('offerablePrice').value);
//                const listed = Boolean(document.getElementById('itemListed').value);
...
//                try {
//                    const response = await fetch('https://your-api-url/api/ItemModification/UpdateItem', {
//                        method: 'POST',
//                        headers: {
//                            'Content-Type': 'application/json',
//                            'username': username
...
//                    if (response.ok) {
//                        messageDiv.textContent = `Item ${sku} Successfully Updated`;
//                        messageDiv.style.color = 'green';
//                    } else {
//                        messageDiv.textContent = `Failed to update item: ${result.message}`;
...
//            });
//        })
//        .then(itemModificationResponse => {
//            if (!itemModificationResponse.ok) {
//                alert('Error occurred while adding item to database. Please try again!');
//                return itemModificationResponse.text().then(text => { throw new Error(`Error during item creation: ${text}`); });
//            }
//            alert('Your item is successfully added to CraftVerify!');
//        })
//        .catch(error => {
