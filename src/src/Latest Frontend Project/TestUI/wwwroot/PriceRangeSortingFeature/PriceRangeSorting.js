(function () {
    ...
    let currentPage = 1;
    let lastSearchTerm = ''; // Add this to track the last search term
    ...
    function fetchItems() {
        ...
        // Reset page number if the price range or search term changes
        if (bottomPrice !== lastBottomPrice || topPrice !== lastTopPrice || name !== lastSearchTerm) {
            currentPage = 1;
        }
    ...
    // Expose the setupPageComponents function to the global scope
    window.setupPageComponents = setupPageComponents;
