document.addEventListener('DOMContentLoaded', function () {
    ...
    showOtpButton.addEventListener('click', function () {
        ...
        document.getElementById('display-otp').textContent = 'Your OTP: ' + otp; // Display the OTP
        //hideGroup('group2');
    ...
    document.getElementById('finalize-registration').addEventListener('click', function (event) {
        ...
        var url = 'http://localhost:5219/AccCreationAPI/api/NormalAccCreationAPI?' + params.toString();
