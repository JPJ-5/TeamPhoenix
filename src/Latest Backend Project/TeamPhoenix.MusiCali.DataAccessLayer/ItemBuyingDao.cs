        ...
        public async Task<bool> InsertRecieptTable(CraftReceiptModel receipt)
        {
            try
            {
                using (var connection = new MySqlConnection(connectionString))
                {
                    ...
                    string commandText = @"
                    INSERT INTO CraftReceipt (CreatorHash, BuyerHash, SKU, SellPrice, OfferPrice, Profit, Revenue, Quantity, SaleDate, Offerable)
                    VALUES (@CreatorHash, @BuyerHash, @SKU, @SellPrice, @OfferPrice, @Profit, @Revenue, @Quantity, @SaleDate, @Offerable);";
                    ...
                    using (var command = new MySqlCommand(commandText, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@Offerable", receipt.Offerable);
